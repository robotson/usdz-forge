...
class Material:
    ...
    def _createSurfaceShader(self, usdMaterial, usdStage):
        ...
        usdMaterial.CreateOutput('surface', Sdf.ValueTypeNames.Token).ConnectToSource(surfaceShader.ConnectableAPI(), 'surface', UsdShade.AttributeType.Output)
    ...
    def _makeUsdUVTexture(self, matPath, map, inputName, channels, uvInput, usdStage):
        ...
        textureShader.CreateInput('st', Sdf.ValueTypeNames.Float2).ConnectToSource(uvReader.ConnectableAPI(), 'result', UsdShade.AttributeType.Output)
    ...
    def _addMapToUsdMaterial(self, inputIdx, usdMaterial, surfaceShader, usdStage):
        ...
        if isinstance(input, Map):
            ...
            surfaceShader.CreateInput(inputName, inputType).ConnectToSource(textureShader.ConnectableAPI(), channels, UsdShade.AttributeType.Output)
